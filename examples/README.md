...
Runnable code samples demonstrating common SDK usage patterns.
...
1. Install and build:
   ...
   npm run build
   ```
2. Replace `YOUR_API_KEY` and `YOUR_BOT_ID` with your real credentials.
3. Run any example:
   ```bash
   node examples/1-posting-stats.js
   ```
